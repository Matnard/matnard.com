...
class Sombrero {
	...
	onload() {
		...
		renderer.domElement.addEventListener('touchstart', ev => ev.preventDefault());
 ...
 this.mainBoxObject.rotation.x += 0.01;
	...
	onWindowResize(width = global.innerWidth, height = global.innerHeight) {
		...
		this.quad.uniforms.u_resolution.value.x = renderer.domElement.width;
		this.quad.uniforms.u_resolution.value.y = renderer.domElement.height;
	}
}
